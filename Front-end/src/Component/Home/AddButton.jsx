...
export default function AddButton({buttonAppear,setbuttoAppear,setBuyerModalOpen}) {
  return (
   <div className="fixed bottom-16 right-4" onMouseEnter={() => setbuttoAppear(true)} onMouseLeave={() => setbuttoAppear(false)} >
          {
            buttonAppear && 
